...
### Fixes
- Filter expired enrollments in findCourseAccessGrants too (f5f21ae1f)
- Filter expired enrollments in web-side entitlement checks (ecfe2c4c6)
- include tracked env fixtures (d0508cf51)
- include Docker env example (e6859e90a)
- scope Kody workflow secrets (0b964dffd)
- format generated kody workflow (685213249)
- remove repository deployment routing (14da3508b)
- make release e2e rebuild self-contained (0cae9c989)
- keep deployment smoke public (8398917d9)
...
### Refactoring
- Move the last two routes, and delete the exceptions list (807f4544f)
- Move code redemption into the service layer (1c96bdbe3)
- Move lesson, media and chat-asset queries down (f6921229a)
- Move heartbeat, activity and upload-session queries down (e4f2f327e)
- Move media and transaction queries into the service layer (1cd189dbd)
- Move the queries into the service layer (8ba97da9c)
- Move dashboard, streak and profile queries down (fe236064e)
- Move entitlement, diagnostic and exercise-import queries down (9a7810217)
- Move the queries into the service layer (c2376e6af)
- Drop AUTH_COOKIE_DOMAIN in favour of ROOT_DOMAIN (54085881a)

### Docs
- Mark shared login live, and add a working second app (21dcc815e)
- Record what the fake database cannot prove (96e2ce786)
...
- add #1018 (b5bb3c0d5)
- add #1017 (63741f1b4)
- Fix prettier formatting in examples/second-app/server.mjs (95705aeb6)
- add #1016 (a7d8df2e5)
- add #1015 (715bd19b8)
- add #1014 (30c01404b)
- add #1013 (fdfaab32d)
- add #1012 (b4cc22d3b)
- add #1011 (bf29051f9)
- add store workflow build-chat-knowledge-graph (45b65cc85)
- add store capability build-chat-knowledge-graph (4573b8593)
- remove store capability build-chat-knowledge-graph (dd9aee626)
- remove store workflow build-chat-knowledge-graph (70de853ad)
- add store workflow build-chat-knowledge-graph (9c0100a0e)
- add store capability collect-chat-knowledge-evidence (d491067b5)
- remove store capability collect-chat-knowledge-evidence (79fe66430)
- remove store workflow build-chat-knowledge-graph (58a2e781e)
- add #1010 (853a7d63d)
- add store workflow build-chat-knowledge-graph (c39e29288)
- add store capability build-chat-knowledge-graph (c03480908)
- remove store capability build-chat-knowledge-graph (ca5b853e9)
- remove store workflow build-chat-knowledge-graph (913bb2d6b)
- add store workflow build-chat-knowledge-graph (f1661734a)
- add store capability collect-chat-knowledge-evidence (17fd6ce02)
- remove store capability collect-chat-knowledge-evidence (805b2aa49)
- remove store workflow build-chat-knowledge-graph (4b772bff1)
- add store workflow build-chat-knowledge-graph (3a5c5001c)
- add store capability build-chat-knowledge-graph (a7e23a24b)
- remove store capability build-chat-knowledge-graph (5769653e4)
- remove store workflow build-chat-knowledge-graph (13548b795)
- add store capability collect-chat-knowledge-evidence (4bee65535)
- add #1009 (c5e7c65de)
- add #1008 (300d45aba)
- add store workflow build-chat-knowledge-graph (45126f126)
- add store capability publish-chat-knowledge-tool (787a4672d)
- remove store capability publish-chat-knowledge-tool (e5837edb2)
- remove store workflow build-chat-knowledge-graph (8dfcaf72e)
- add store workflow build-chat-knowledge-graph (16d3a28cd)
- remove store workflow build-chat-knowledge-graph (8c5e79d9f)
- remove migrated deployment secrets (188f7ad26)
- add #1004 (6937efad0)
- complete atomic vault migration (eec0e8f07)
- add store workflow build-chat-knowledge-graph (874aa81f2)
- remove store workflow build-chat-knowledge-graph (f2c1926c0)
- finish serialized secret migration (9cfc5e987)
- retry serialized secret migration (f4baf02db)
- complete deployment secret migration (414b3e535)
- migrate deployment secrets to vault (7d85e1dd4)
- add #1006 (cb342036d)
- set engine model (4a09da917)
- sync engine workflow to latest template (b3188e056)
- add #1005 (7402e62ed)
- add store workflow build-chat-knowledge-graph (9441efe59)
- add #1003 (8de3bd5f4)
- add #1002 (49588cd46)
- add #1001 (7a8ec4620)
- add #1000 (1e366d9d0)
- configure generic release deployment (88810fbf1)
- add #998 (eeb78d1ac)
- Keep database queries out of API routes (3a279bba4)
- add #997 (f991b9f08)
- add #996 (428419e93)
- add #995 (0afd8c3e3)
- add #994 (e9569ed7d)
...
### Other
- Add $nin support to fake content DB helper (d7a170b91)
- Delete the users these tests create (5cdf1939e)
- Sign in before visiting pages that require a session (246f2819c)
- Fill in the fields Payload used to supply when seeding (c4edb7b2b)
- Sign in before visiting the course catalogue (a740b6132)
- Get the browser tests loading again after the Payload removal (59a5e24c2)
- Cover what the fake database cannot show (b77e98209)
- Pin behaviour of the eight untested routes (7df870201)
...
### Features
- Shared login across sibling subdomain apps (b028973e6)
- Wire PayPal subscriptions into checkout flow (79f5c0678)
- Show only PayPal on the product buy button (493f01ce6)
- gate build, CI, and Vercel deploy on env validation via shared Zod schema (186c14886)
- Swap scroll tab for test tab on exam lessons (ad94c8549)
- Unify test view check-all button across all exercises (357d0f144)
- Unify test view check-all button across all exercises (aa6b699ef)
- redesign lessons view with chapter accordions and timeline (52b68620f)
- Track course selections in Admin from every call site (b748dfd96)
- Add Guy math teacher agent (ce486c891)
- grant course + feature entitlements on successful PayPal checkout (#809) (18235dac3)

### Fixes
- Make the return destination a type the compiler can check (a3ee4faec)
- Resolve returnTo on the server, and split shared login into units (7e320d628)
- Keep Kody launcher minimal (14c1c0ebd)
- refresh Kody workflow launcher (bd596920c)
- Refresh Kody workflow launcher (2965ab6f7)
- Resolve success page lookup for PayPal subscription returns (eff6d1dfe)
- Round-3 review UX + concurrency fixes (318195fc6)
- Round-2 review fixes on subscription checkout (f609a6d61)
- Address review feedback on subscription checkout (5c8f0acb7)
- Address PR #978 review — restore lesson-row typography (b57eede22)
- Yellow-tint locked lesson rows in course roadmap (587052104)
- Ignore test-only config files at repo root to unblock build (55c46cdd5)
- Unignore scripts/ so build can invoke validate-env.ts (33682fb8b)
- Tolerate an equivalent Mongo index under a different name (a40768747)
- enforce TypeScript and ESLint checks during builds (38380fe02)
- Add CRON_SECRET and PREVIEW_SECRET fallbacks to Build job env (b5bc019aa)
- Resolve legacy issue sweep findings (62b67a372)
- Enforce API access boundaries (ab86100c8)
- Restore soft yellow tint on locked lesson card CTA (9075574db)
- Remove  ( true from pnpm audit step so failures actually gate CI||e26956b63)
- Use pnpm test:unit:coverage instead of test:unit -- --coverage (6c40bfddb)
- calculate streaks in user timezone (cdf1f9079)
- drop section headers, separate exercises in scroll view (3e729a72e)
- join sections via reverse relationship (7aab69ca6)
- render own blocks + sections with localized a/b/c headers (#880) (bbb803f09)
- Address review feedback + fix regression test (e8602dd66)
- Capture PayPal orders from /checkout/success return handler (#827) (90502d194)
- resolve page refs by slug when the CMS stores slug strings (#821) (d71f4d675)
- read global from Payload's 'globals' collection (#820) (b13817e58)
- Restore course landing render for paid courses (#818) (a2e0087f8)
- drop now-unused Media type import (b050f42f8)
- stop pulling MongoDB into the client bundle (cc12e44f0)
- Responsive layout for product detail on mobile (18408e5be)

### Refactoring
- Drop AUTH_COOKIE_DOMAIN in favour of ROOT_DOMAIN (54085881a)
- Remove guest chat identity and require a session for all chat routes (e220276ef)
- unify selected-course state behind userProfile module (#807) (8f6a73b0d)
- remove course.pageAccessType readers ahead of Admin schema drop (a2c713d6f)

### Docs
- Fold the sharing note into the platform doc (c632b0202)
- Record what we share across apps (dc01eca2b)
- Use the real domain in shared-login examples (4a5852a3f)
- update docs/rollout-aug-26.md (91c6e200a)
- remove docs/new-doc.md (859d01143)
- rename docs/new-doc.md to docs/rollout-aug-26.md (5dce5e106)
- update docs/new-doc.md (0f9689b06)
- update docs/new-doc.md (7e631919c)
- update docs/new-doc.md (2ce9554fe)
- update docs/new-doc.md (8bcb576f4)
- update docs/new-doc.md (ea481c3c5)
- update docs/new-doc.md (d0914cd4c)
- update docs/new-doc.md (edcfdde5e)
- update docs/new-doc.md (5ca42b238)
- update docs/new-doc.md (a977ff4e8)
- add docs/new-doc.md (5c4dc1b29)
- refresh ExerciseRendererProps.groups docstring (fba2b76c6)
...
- add #984 (c65ba4f72)
- add #983 (c696b6fc0)
- update docs/rollout-aug-26.md (924a0a7e1)
- update docs/rollout-aug-26.md (044e5b26d)
- update docs/rollout-aug-26.md (d242831ac)
- update docs/rollout-aug-26.md (3a0894dae)
- update docs/rollout-aug-26.md (ec90839bb)
- update docs/rollout-aug-26.md (e7c882ca2)
- update docs/rollout-aug-26.md (c8dd32b3b)
- add #982 (6553c0998)
- update docs/rollout-aug-26.md (40d1691fc)
- update docs/rollout-aug-26.md (eb9e60fb6)
- update docs/rollout-aug-26.md (24d971edb)
- add #980 (59e8dee2b)
- add #981 (3c48a2078)
- update loop daily-web-release-loop (b7e727c3b)
- add store loop daily-web-release-loop (9fab9d4f0)
- add store workflow web-release (7f17d8c1d)
- add #978 (6cadcde49)
- add #979 (4dce2ab30)
- Restore codemod docstring after self-transform (70b20096c)
- add #975 (97ee70686)
- Bump js-yaml and brace-expansion via pnpm overrides for 2 high CVEs (e9810959d)
- update docs/rollout-aug-26.md (d410afb60)
- update docs/rollout-aug-26.md (c3037fbc5)
- update docs/rollout-aug-26.md (efdc643a0)
- update docs/rollout-aug-26.md (5e2d77b9c)
- update docs/rollout-aug-26.md (31aba9bc7)
- update docs/rollout-aug-26.md (32e44c71f)
- update docs/rollout-aug-26.md (bb6f8ae32)
- update docs/rollout-aug-26.md (34b93741e)
- update docs/rollout-aug-26.md (2a1ca92c4)
- update docs/rollout-aug-26.md (e6bd6f5d3)
- update docs/rollout-aug-26.md (b110b6f7f)
- update docs/rollout-aug-26.md (e530e5ce0)
- update docs/rollout-aug-26.md (9c92d4cb0)
- move notes/test/test.md to notes/test.md (57740a9b7)
- move notes/test.md to notes/test/test.md (993f0dca1)
- move notes/test/test.md to notes/test.md (933746546)
- move notes/test.md to notes/test/test.md (aa20fb3dc)
- create notes/test/ (e94419188)
- create notes/test/ (ec9d72b2d)
- delete notes/test (526805167)
- move notes/test/test.md to notes/test.md (9c0e4475d)
- set engine model (b62633dab)
- sync engine workflow to latest template (edd86d969)
- add store workflow refresh-knowledge-system (7163c870d)
- add #971 (b847974d2)
- add #955 (b6e3ad818)
- add #952 (9e3b56370)
- add #956 (436f9e02d)
- add #969 (e92a1c259)
- Format kody.yml per repo Prettier config (78f3cb758)
- Bump next from 15.5.18 to 15.5.21 to patch 3 high CVEs (9fc3e88de)
- set engine model (bdc43253e)
- sync engine workflow to latest template (99d4b2495)
- chore(analytics): gate console.log calls behind debug logger and enable no-console lint rule (deef2e60d)
- Remove obsolete Inspector workflow (35109366f)
- add #951 (0486fbe2f)
- fix(ci): enforce high-severity dependency audit (1bc6f7b14)
- add #950 (1ba17a4b8)
- add #949 (f1aa1441a)
- fix(api): validate ObjectId in chat-assets/finalize to return 400 instead of 500 (9d114c3e9)
- fix(security): move GEMINI_API_KEY from URL query string to x-goog-api-key header (be22f5607)
- add #948 (43c0d587c)
- kody changes (8bca521a0)
- add #943 (d28a6a873)
- add #946 (92a1d4ba4)
- add #947 (c5b91321d)
- kody changes (f1887d170)
- add #945 (2b7b6919b)
- add #944 (819b5bdd2)
- feat(security): replace in-memory rate limiter with durable Mongo TTL-backed helper (80c1c2ea4)
- fix(security): escape regex and reject object values in shared Mongo where translator (b40b63fe4)
- fix(ci): enforce unit-test coverage thresholds in CI (423eeb291)
- move notes/test.md to notes/test/test.md (0b29e0927)
- move notes/test/test.md to notes/test.md (94835b240)
- move notes/test.md to notes/test/test.md (85db23101)
- create notes/test/ (457ae0dea)
- create notes/test/ (6892dc8e4)
- create notes/test.md (01a700294)
- create notes/test.md (1c685466f)
- delete notes/Test.md (59d51d2f4)
- create notes/Test.md (9cfcc836f)
- create notes/Test.md (5e9a26aff)
- create notes/ file space (f31c09fa6)
- add #941 (39950b048)
- add store capability resolve (1f6f8cd8b)
- remove store capability resolve (e31cffb7b)
- add store capability fix (b6c9b301c)
- remove store capability fix (02eae6977)
- add #924 (8505ed119)
- feat(home): redirect logged-in users with a picked course to /courses/{slug} (6771b8d34)
- add #922 (1fe5a92b1)
- add #921 (2748ccf6e)
- add #920 (df191cb22)
- Remove legacy state repository configuration (3a5def0f5)
- mark #882 QA failed (environment blocker) — see #911 (5698fb67d)
- add store agentLoop agency-operating-loop (821bf91c5)
- add store agentLoop agency-observer (6c726102d)
- start QA for #882 (ecb03a637)
- resolve #883 — environment blocker (#895) (e4037cd73)
- add #907 (9e55c92d2)
- start QA for #883 (07e2132c1)
- add #889 (977d26010)
- mark #874 as QA-issues (93e40a4b0)
- add #885 (5fbb2433a)
- add #888 (1611427b3)
- add #887 (13644f192)
- feat(mcq): auto-check 2-option MCQ on button click (52656e422)
- feat(lessons): add Test view renderer with batch answer checking (8aa7bbacd)
- add #882 (762e7708f)
- add #883 (e8b131d43)
- fix(exercises): render own blocks + sections with localized a/b/c headers (#880) (aab633d43)
- feat(mcq): render 2-option single-select as side-by-side buttons (0a8cb4016)
- start QA for #874 (86c42b3f6)
- start QA for #857 — report received, BLOCKED (2ad216a3b)
- add #874 (231617dda)
- Apply prettier formatting fixes (802dfd13f)
- start QA for #857 (f19f1a9b5)
- start QA for #845 (resolve #850) (5673ec034)
- add #857 (c7622707f)
- kody changes (d9065feb0)
- start QA for #845 (fd4261c31)
- add #845 (832e38426)
- mark #813 as concerns (issue #817) (f9815f4ce)
- release v0.28.0 (6fe5dfd08)
- add #829 (0a1e6474e)
- add #831 (a346c221a)
- add #830 (f0b07780d)
- sync main into dev to unblock v0.28.0 promotion (#830) (f7dec8dc8)
- add #828 (36a8c8749)
- add #827 (075b1f825)
- add #821 (4d0c84c5e)
- add #820 (a419302af)
- add #818 (460d59301)
- add #815 (47bdbfb1f)
- feat(brands): swap aguy logo for bilingual mark with baked-in גאי wordmark (#815) (fb3439085)
- start QA for #813 (41ed93149)
- add #816 (a7336f0cc)
- feat(courses): route lesson intro back button to course page (#816) (1bb115a8b)
- add #810 (f89089c24)
- feat(billing): grant course entitlements on PayPal purchase success (#689) (#810) (48cb66611)
- add #804 (b7a3e299d)
- docs(system-events): add folder-level README (#804) (3cf1b5904)
- add #805 (8c9e8141a)
- add #796 (cbfbb762a)
- test(lesson-pager): lock in jump-to-exercise input visual order (#704) (#796) (fd8604b26)
- add #807 (c387f8263)
- add #799 (54f2f6dde)
- fix(lesson): widen outro + complete containers to match content-page width (#799) (213a2623a)
- add #812 (2c6eed7fd)
- fix(a11y): render lesson HtmlBlock through SafeHtml with enableProse (#812) (42a74ad72)
- add #755 (3f5110cd6)
- fix(study): hide orphan course id when requested course does not exist (#754) (#755) (32b9dea1e)
- add #809 (625a5a1ce)
- add #813 (296277922)
- kody changes (#813) (4a13df31d)
- release v0.27.0 (c3c7d7cd9)
- add #803 (d4547d54c)
- add #801 (a5a09523d)
- add #802 (95b0036a3)
- remove approval loop fixture (d1edbaf5a)
- add approval loop fixture (986d4d26a)
- add #798 (1f62d81bc)
- feat(footer): dynamic CMS-driven footer with legal-page modal (23b1d9cea)
- add #795 (3b0fae244)
- add #786 (14eb4216d)
- test(products): add regression tests for #785 mobile-responsive layout (25918fc4c)
- add #782 (0b0da792a)
- add #779 (5d20c3532)
- add #787 (8a89ebb8d)
- fix(prep7): pin logo to brand hexes and add explicit dark-mode text variants (#787) (6fb21d724)
- add #794 (80190687d)
- feat(lesson): add mobile chat overlay "back to exercise" control (#794) (6c7dbc12c)
- add #791 (a1ce9f26d)
- chore(i18n): add auth.login.brand.heroSubtitle to locale files (issue #205) (#791) (94965146b)
- add #790 (945daf5d0)
- fix(start): revert StartPageClient.tsx to pre-c44a9fb6 layout (#790) (8a496d04e)
- add #788 (a5bef78a7)
- fix(login): make submit button wire through to loginAction after logout (issue #780) (#788) (06c290ccc)
- fix(auth): mobile Google login after /start now persists (issue #783) (cc3a617eb)
- feat(auth): refresh onboarding completion modal copy (4d9236ab7)
- add #771 (adbed2ed2)
- add #763 (5cfc62386)
- fix(paywall): reuse activeProductFilter, match both ObjectId and string course refs, log resolver errors (88f136407)
- feat(paywall): route locked lesson clicks to the course's product page (1aea44fab)

### Other
- Fix checkout responsive tests after paypal-only merge (8ca759d9b)
- Update BuyButton responsive assertions for paypal-only (7017c5bfb)
- Update stale unit tests to match current component and query shapes (2b267cb7f)
- update (d2e798d21)
- #928: Security: AI/paid-API endpoints are unauthenticated and unthrottl… (#941) (c67dd0cff)
- #690: design: health sweep 2026-07-01 (#805) (1ea558a59)
## v0.30.1 — 2026-07-29
...
- promote: dev -> main (v0.31.7) ([#1069](https://github.com/A-Guy-educ/A-Guy-Web/pull/1069)) — @aguyaharonyair
- chore: release v0.31.7 ([#1068](https://github.com/A-Guy-educ/A-Guy-Web/pull/1068)) — @aguyaharonyair
...
- fix(svg): Inject viewBox on render so uploaded SVGs scale correctly ([#1022](https://github.com/A-Guy-educ/A-Guy-Web/pull/1022)) — @aguyshayb
- promote: dev -> main (v0.30.14) ([#1021](https://github.com/A-Guy-educ/A-Guy-Web/pull/1021)) — @aguyaharonyair
- chore: release v0.30.14 ([#1020](https://github.com/A-Guy-educ/A-Guy-Web/pull/1020)) — @aguyaharonyair
- promote: dev -> main (v0.30.13) ([#1019](https://github.com/A-Guy-educ/A-Guy-Web/pull/1019)) — @aguyshayb
...
- promote: dev -> main (v0.30.10) ([#1012](https://github.com/A-Guy-educ/A-Guy-Web/pull/1012)) — @aguyaharonyair
...
- chore: release v0.30.7 ([#1002](https://github.com/A-Guy-educ/A-Guy-Web/pull/1002)) — @aguyaharonyair
...
- #881: Render 2-option MCQ as side-by-side buttons ([#882](https://github.com/A-Guy-educ/A-Guy-Web/pull/882)) — @kodyade[bot] · ⚠️ QA 2026-07-18 (#911)
...
- #757: QA: fix(lesson): Pre-render content page bodies and pass to lesso… ([#813](https://github.com/A-Guy-educ/A-Guy-Web/pull/813)) — @kodyade[bot] · ⚠️ QA 2026-07-11 (#817)
## [v0.27.0] - 2026-07-09
